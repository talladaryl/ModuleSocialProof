...
class StorePlanRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => 'required|string|max:100|unique:sp_plans,slug',
            ...
            'max_widgets' => 'required|integer|min:1|max:1000',
            'max_notifications' => 'required|integer|min:1|max:10000',
            'max_monthly_events' => 'required|integer|min:1000|max:999999999',
            'max_team_members' => 'required|integer|min:1|max:100',
            'max_api_keys' => 'required|integer|min:1|max:50',
