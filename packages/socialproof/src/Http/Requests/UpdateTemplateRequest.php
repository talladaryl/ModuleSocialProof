...
class UpdateTemplateRequest extends FormRequest
{
    ...
    {
        $templateId = $this->route('template')->template_id;
        ...
        return [
            ...
            'slug' => [
                ...
                'string',
                'max:191',
                Rule::unique('sp_templates', 'slug')->ignore($templateId, 'template_id')
            ],
            'description' => 'nullable|string|max:1000',
            'type' => 'sometimes|required|in:notification,popup,banner,sidebar,floating,inline',
