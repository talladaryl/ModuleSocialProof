 ...
 */
export const markDisplayed = (args: { apiKey: string | number, notification: string | number | { id: string | number } } | [apiKey: string | number, notification: string | number | { id: string | number } ], options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/api/socialproof/widget/{apiKey}/notifications/{notification}/displayed'
 */
markDisplayed.url = (args: { apiKey: string | number, notification: string | number | { id: string | number } } | [apiKey: string | number, notification: string | number | { id: string | number } ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
                    apiKey: args[0],
                    notification: args[1],
 ...
 * @route '/api/socialproof/widget/{apiKey}/notifications/{notification}/displayed'
 */
markDisplayed.post = (args: { apiKey: string | number, notification: string | number | { id: string | number } } | [apiKey: string | number, notification: string | number | { id: string | number } ], options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: markDisplayed.url(args, options),
    method: 'post',
})
 ...
 * @route '/api/socialproof/widget/{apiKey}/notifications/{notification}/displayed'
 */
    const markDisplayedForm = (args: { apiKey: string | number, notification: string | number | { id: string | number } } | [apiKey: string | number, notification: string | number | { id: string | number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/api/socialproof/widget/{apiKey}/notifications/{notification}/displayed'
 */
        markDisplayedForm.post = (args: { apiKey: string | number, notification: string | number | { id: string | number } } | [apiKey: string | number, notification: string | number | { id: string | number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: markDisplayed.url(args, options),
            method: 'post',
        })
