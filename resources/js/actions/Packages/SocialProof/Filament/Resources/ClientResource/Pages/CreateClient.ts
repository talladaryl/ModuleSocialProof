...
/**
* @see \Packages\SocialProof\Filament\Resources\ClientResource\Pages\CreateClient::__invoke
 * @see packages/socialproof/src/Filament/Resources/ClientResource/Pages/CreateClient.php:7
 * @route '/socialproof-admin/clients/create'
 */
...
CreateClient.definition = {
    methods: ["get","head"],
    url: '/socialproof-admin/clients/create',
