...
/**
* @see \Packages\SocialProof\Filament\Resources\CampaignResource\Pages\ViewCampaign::__invoke
 * @see packages/socialproof/src/Filament/Resources/CampaignResource/Pages/ViewCampaign.php:7
 * @route '/socialproof-admin/campaigns/{record}'
 */
...
ViewCampaign.definition = {
    methods: ["get","head"],
    url: '/socialproof-admin/campaigns/{record}',
