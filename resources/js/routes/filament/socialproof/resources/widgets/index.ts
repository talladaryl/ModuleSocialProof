...
/**
* @see \Packages\SocialProof\Filament\Resources\WidgetResource\Pages\ViewWidget::__invoke
 * @see packages/socialproof/src/Filament/Resources/WidgetResource/Pages/ViewWidget.php:7
 * @route '/socialproof-admin/widgets/{record}'
 */
...
view.definition = {
    methods: ["get","head"],
    url: '/socialproof-admin/widgets/{record}',
} satisfies RouteDefinition<["get","head"]>
